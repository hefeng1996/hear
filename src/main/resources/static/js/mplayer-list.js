...
var hearPath=function getHearPath() {
	...
	var pos = curWwwPath.indexOf(pathName);
	var localhostPaht = curWwwPath.substring(0, pos);
	var hearPath = localhostPaht + "/hear/Hear";
	return hearPath;
};
var mplayer_song = [[
	{
	...
	},
	{
		...
		"lrc":"[00:00.63]穿越火线 - G.E.M.邓紫棋\n" +
			...
			"[00:02.09]编曲：任中强\n" +
			"[00:02.56]制作人：任寒冰\n" +
			"[00:03.01]Rap：G.E.M. 邓紫棋\n" +
			"[00:03.42]配唱制作人：G.E.M. 邓紫棋&周锡汉\n" +
			"[00:03.88]吉他：任中强\n" +
			"[00:04.29]和音：G.E.M. 邓紫棋&汪苏泷&梁古驰\n" +
			"[00:04.80]录音：Thomas Lo@Q2 Studio\n" +
			"[00:05.34]混音：曹飞@中国唱片厂\n" +
			"[00:05.91]母带：Leonard Fong@新加坡Horus Studio\n" +
			"[00:06.51]监制：廖婷婷\n" +
			"[00:09.06]越来越多人 失去了灵魂\n" +
			"[00:13.24]我们怎么能 听而不闻\n" +
			"[00:20.52]看 四起的混乱 四处舌剑唇枪\n" +
			"[00:23.34]四面不胜防 都是遍体损伤\n" +
			"[00:25.76]难道伪装是生存最后一丝的阳光\n" +
			"[00:28.49]难道世界容不下一点不一样\n" +
			"[00:30.74]为了我们的自尊和梦想而战\n" +
			"[00:33.02]拿起枪而音乐是我的子弹\n" +
			"[00:35.56]谁能抵抗我的黑与白成与败\n" +
			"[00:37.79]兴与衰恨与爱我说了算\n" +
			"[00:40.90]机枪子弹上膛 呼吸血脉喷张\n" +
			"[00:45.61]战场再硝烟弥漫有你我愿闯一闯\n" +
			"[00:50.26]迎面过的战壕 躲避过的弹药\n" +
			"[00:54.79]在危难时你和我就是彼此的肩膀\n" +
			"[00:59.59]等黎明的太阳 等第一声枪响\n" +
			"[01:04.45]你说过就算痛也要记得微笑\n" +
			"[01:08.84]为爱 必须冒险 穿越火线\n" +
			"[01:16.01]才看到未来\n" +
			"[01:20.70]再多威胁 穿越火线\n" +
			"[01:25.07]浴血捍卫爱\n" +
			"[01:28.48]越来越多人 失去了灵魂\n" +
			"[01:30.57]我们怎么能 听而不闻\n" +
			"[01:32.94]越来越多人 失去了灵魂\n" +
			"[01:35.44]我们怎么能\n" +
			"[01:36.80]城里充斥着陷阱\n" +
			"[01:39.15]现实充满着限定\n" +
			"[01:41.37]但拦不住我的前进\n" +
			...
			"[01:50.55]一颗不服输的决心\n" +
			"[01:52.96]也许就是年轻的使命\n" +
			"[01:55.65]一天有太阳 就不必绝望\n" +
			"[02:00.69]我们的未来决定在我们手上\n" +
			"[02:05.04]为爱 必须冒险 穿越火线\n" +
			"[02:12.05]才看到未来\n" +
			"[02:16.59]再多威胁 穿越火线\n" +
			"[02:21.18]浴血捍卫爱\n" +
			"[02:24.60]在这个时代 多么奇怪\n" +
			"[02:26.75]雨打得澎拜 风被争得厉害\n" +
			"[02:29.25]金玉的外在 然而败絮却无改\n" +
			"[02:31.25]面具不戴会被掩埋\n" +
			"[02:32.38]太真实的会被伤害\n" +
			"[02:33.46]人们 用毒舌捍卫自尊\n" +
			"[02:35.20]用羞辱换来身份\n" +
			"[02:36.20]用放肆兑等青春 大写的愚蠢\n" +
			"[02:38.38]太善良的人 洪流下无法生存\n" +
			"[02:40.53]难到我们真的就能\n" +
			"[02:41.64]视而不见听而不闻\n" +
			"[02:42.83]为爱 穿越火线\n" +
			"[02:51.76]为爱 穿越火线\n" +
